    ...
    const fetchTeamData = async () => {
      try {
        ...
        const teamResponse = await fetch(
          `${backendUrl}/api/v1/team/get-team/${teamId}`
        );
        if (!teamResponse.ok) {
        ...
        const messagesResponse = await fetch(
          `${backendUrl}/api/v1/message/${teamId}`,
          {
            method: "POST",
                    ...
                    team.joinRequests.map((request, index) => (
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          <button
                            onClick={() =>
                              acceptRequest(team._id, request.userId._id)
                            }
                          ...
                          <button
                            onClick={() =>
                              rejectRequest(team._id, request.userId._id)
                            }

  ...
  return (
    <div className="text-center bg-gradient-to-r from-purple-900/30 to-indigo-900/30 rounded-xl p-8 overflow-hidden relative">
      ...
      <p className="text-neutral-300 max-w-3xl mx-auto mb-8">
        Support the next generation of innovators and put your brand in front of thousands of talented developers. Join other industry leaders on <span className="text-purple-500 font-bold">HackIn</span> and connect with the brightest minds in tech through hackathon sponsorships, mentorship opportunities, and exclusive recruiting access.
      </p>
      <Link 
        to="/add-sponsor" 
